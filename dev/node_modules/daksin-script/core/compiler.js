...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var files, i, file, findFunctions, firstStage, secondStage, thirdStage, s4, nameForFile;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    nameForFile = files[i].name.replace(/\.djs/gm, '.js');
                    return [4 /*yield*/, writeFile("./res/" + nameForFile, s4, 'utf-8', function (err) {
                            if (err)
                                throw err;
                            console.log('done');
                        })];
